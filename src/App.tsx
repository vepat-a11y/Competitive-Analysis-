      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 mt-8">
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-32 bg-white rounded-xl border border-slate-200 shadow-sm">
            ...
            <p className="text-sm text-slate-500 font-semibold tracking-wide uppercase">Initializing Competitor Intel...</p>
            <p className="text-xs text-slate-400 mt-1">Fetching latest metrics and store catalogs</p>
          </div>
        ) : (
          <>
            {/* Stats Summary Cards */}
